...
import { z } from "zod";
import { markTodoModified, markTodoDeleted } from "@/lib/caldav/change-tracker";
import { emptyExdates } from "@/lib/prisma/db-adapter";
...
export async function DELETE(
  ...
  try {
    ...
    // Track deletion for CalDAV sync before deleting
    markTodoDeleted(id);
